	...
	return (
		<>
			<div
				...
				onClick={(e) => {
					if (e.currentTarget == e.target) stb.click();
				}}>
				<div
					id="settingsPage"
					...
					style={{
						...
						width:
							Math.min(window.innerWidth, 1024 * props.scale) +
							"px",
					}}>
					<div
						className="flex w-full h-full duration-300 bg-opacity-50 bg-post backdrop-blur-md "
						style={{
