...
function MusicPlayer() {
  ...
  return (
    <>
      <div className=" text-[1vh] pt-[0.5vh] min-w-[28vh]   flex gap-1  items-center text-bcol  justify-center aspect-square h-[60px] min-h-[5vh] max-h-[10vh]  ">
        <div className="h-full w-[4vh] select-none items-center justify-evenly flex flex-col">
          ...
          <div
            id="musicCurrentTime"
            className="h-1/3 flex text-[125%] mb-[0.25vh] items-center justify-center text-center w-[4vh]" //Music current time in mm:ss
          >
        ...
        <div className="h-full w-[20vh]  justify-evenly   flex flex-col">
          <div
            id="songName"
            className="h-1/3 text-[150%] w-full overflow-hidden text-ellipsis whitespace-nowrap  flex items-center" //Song name
          >
            {songName}
          </div>
          <div className="h-1/3 flex items-center ">
            ...
            >
              <div
                ...
                style={{
                  width: (musicCurrentTime / musicDuration) * 100 + "%",
                }}
              ></div>
            </div>
          </div>
        ...
        <div className="h-full w-[4vh] select-none  items-center justify-evenly   flex flex-col">
          ...
          >
            ...
            <div
              ...
              className="h-[110%] bg-bact duration-300 rounded-sm aspect-[1/10] rotate-45 -ml-[50%]"
            ></div>
          </div>
          <div
            id="musicDuration"
            className="w-[4vh] flex text-[125%] mb-[0.25vh] items-center justify-center text-center h-1/3" //Music Duration in mm:ss
          >
