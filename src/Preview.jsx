...
function Preview() {
	return (
		<>
			<div
				className="bg-post bg-opacity-25 h-[15vw] w-[55vw] fade-in2 text-center  fixed top-[62px]  left-[-8vw] rounded-lg rounded-tr-none outline outline-bcol outline-1 overflow-hidden"
				style={{
					transform:
						"skew(-" +
						skewDeg +
				...
				<div
					...
					<div className="bottom-[12%] flex font-bold text-[20px] gap-1 absolute">
						...
						<div
							id="previewMapper"
							className=" text-blue-400 brightness-125">
							{"[Mapper]"}
						</div>
					</div>
				</div>
			...
			<div
				id="infobox"
				className="bg-post bg-opacity-45 p-5 fade-in2 text-base h-fit gap-8 w-[calc(44vw-10px)] flex flex-row  fixed top-[calc(15vw+75px)]  left-[5px] rounded-md outline outline-bcol outline-1 ">
				<div
					id="circleSize"
